...
\ifthenelse{\boolean{czech}}
    {
    \ifthenelse{\boolean{bc}}{bakalářská}{diplomová} práce
    }
    {
    \ifthenelse{\boolean{bc}}{bachelor's}{master's} thesis
    }
}
\end{center} 
...
\begin{tabular}{>{\bfseries}rl}
    \autorNazev: 	& \autor\\
    \vedouciNazev: 	& \vedouci\\
&\\
\programNazev:       & \program\\
\ifthenelse{\boolean{is}}{\oborNazev:          & \obor\\}{}
\end{tabular} 
}
\vspace{1.5cm}
\begin{center}
...
\thispagestyle{empty} 
{\bfseries \ifthenelse{\boolean{czech}}{Prohlášení}{Affirmation}}
...
I declare hereby that I have written this \ifthenelse{\boolean{bc}}{bachelor's}{master's} thesis independently and used solely the sources
which I quote in the enclosed list of literature.
}
...
\ifthenelse{\boolean{czech}}{V}{In} Ústí nad Labem\ifthenelse{\boolean{czech}}{ dne}{,} \today   \hfill \ifthenelse{\boolean{czech}}{Podpis}{Signature}: \makebox[4cm][s]{\dotfill}
...
\begin{flushright}
    \ifthenelse{\boolean{czech}}
    {
        ...
        za neocenitelné rady a pomoc při tvorbě \ifthenelse{\boolean{bc}}{bakalářské}{diplomové} práce.
    }{
        I thank the thesis supervisor \ZT{\vedouciDAT}\\ 
        for invaluable advice and help in the preparation of this \ifthenelse{\boolean{bc}}{bachelor's}{master's} thesis.
    }
\end{flushright}
